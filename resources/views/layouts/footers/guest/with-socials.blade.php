          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      Copyright © {{ now()->year }} Development  <a style="color: #252f40;" href="https://www.creative-tim.com"
                          class="font-weight-bold ml-1" target="_blank">IT Team</a> By <a style="color: #252f40;"
                          href="#" class="font-weight-bold ml-1" target="_blank">Mediatama</a>
              </div>
              </p>
          </div>
      </div>
