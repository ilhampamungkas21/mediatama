                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="font-weight-bolder text-info text-gradient">{{ __('Mediatama') }}</h3>
                            <p class="mb-0">{{ __('Create a new acount')}}<br></p>
                            <p class="mb-0">{{__('OR Sign in with these credentials:') }}</p>
                            <p class="mb-0">{{ __('Email ') }}<b>{{ __('admin@mediatama.com') }}</b></p>
                            <p class="mb-0">{{ __('Password ') }}<b>{{ __('secret') }}</b></p>

                            <p class="mb-0">{{ __('Email ') }}<b>{{ __('cust2@gmail.com') }}</b></p>
                            <p class="mb-0">{{ __('Password ') }}<b>{{ __('customer123') }}</b></p>

                        </div>

                        <div class="text-left" wire:loading wire:target="login">
                            <p>Tunggu, Sedang Cek Akun</p>
                ...
                <div class="col-md-6">
                    <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                        <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                            style="background-image:url('../assets/img/curved-images/cover.png')"></div>
                    </div>
                </div>
            </div>
        </div>
